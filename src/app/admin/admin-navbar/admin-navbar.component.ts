...
@Component({
	...
	standalone: true,
	imports: [CommonModule, FlexLayoutServerModule, RouterModule,FontAwesomeModule, MatSidenavModule, MatExpansionModule, MatIconModule, MatListModule, MatToolbarModule],
