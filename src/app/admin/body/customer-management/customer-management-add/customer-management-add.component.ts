...
@Component({
    selector: "app-customer-management-add",
    standalone: true,
    imports: [
        CommonModule,
        MatFormFieldModule,
    ...
    styleUrl: "./customer-management-add.component.scss",
})
export class CustomerManagementAddComponent {
    offset = 7;
    target: string = "Add";
    myform!: FormGroup;
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<CustomerManagementAddComponent>,
