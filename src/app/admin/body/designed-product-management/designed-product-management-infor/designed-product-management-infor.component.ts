...
@Component({
    ...
    templateUrl: "./designed-product-management-infor.component.html",
    styleUrl: "./designed-product-management-infor.component.scss",
    providers: [TitleCasePipe],
})
export class DesignedProductManagementInfor implements OnInit {
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<DesignedProductManagementInfor>,
    ...
    buildFormGroup() {
        return this.fb.group({
            ...
            orderDate: [
                this.dialogData.item ? this.dialogData.item.updated_at : "",
                [Validators.required, CustomValidator.numeric],
            ],
            message: [
